...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/user/interchange/blog/post
         */
        this.queryPostAll = (query, params = {}) => this.request({
            path: `/user/interchange/blog/post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/user/interchange/blog/post/{id}
         */
        this.queryPost = (id, params = {}) => this.request({
            path: `/user/interchange/blog/post/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/user/interchange/blog/sentPost
         */
        this.querySentPostAll = (query, params = {}) => this.request({
            path: `/user/interchange/blog/sentPost`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/user/interchange/blog/sentPost/{id}
         */
        this.querySentPost = (id, params = {}) => this.request({
            path: `/user/interchange/blog/sentPost/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/user/interchange/blog/timedoutPost
         */
        this.queryTimedoutPostAll = (query, params = {}) => this.request({
            path: `/user/interchange/blog/timedoutPost`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/user/interchange/blog/timedoutPost/{id}
         */
        this.queryTimedoutPost = (id, params = {}) => this.request({
            path: `/user/interchange/blog/timedoutPost/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });

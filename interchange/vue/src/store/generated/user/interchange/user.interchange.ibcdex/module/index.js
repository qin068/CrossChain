...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgSendSellOrder: (data) => ({ typeUrl: "/user.interchange.ibcdex.MsgSendSellOrder", value: data }),
        msgSendBuyOrder: (data) => ({ typeUrl: "/user.interchange.ibcdex.MsgSendBuyOrder", value: data }),
        msgCancelBuyOrder: (data) => ({ typeUrl: "/user.interchange.ibcdex.MsgCancelBuyOrder", value: data }),
        msgSendCreatePair: (data) => ({ typeUrl: "/user.interchange.ibcdex.MsgSendCreatePair", value: data }),
        msgCancelSellOrder: (data) => ({ typeUrl: "/user.interchange.ibcdex.MsgCancelSellOrder", value: data }),
    };
};

declare const _default: {
    ...
    UserInterchangeUserInterchangeBlog: (store: any) => void;
    UserInterchangeUserInterchangeIbcdex: (store: any) => void;
    UserInterchangeUserInterchangeMessage: (store: any) => void;
};

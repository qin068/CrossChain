...
import UserInterchangeUserInterchangeBlog from './user/interchange/user.interchange.blog';
import UserInterchangeUserInterchangeIbcdex from './user/interchange/user.interchange.ibcdex';
import UserInterchangeUserInterchangeMessage from './user/interchange/user.interchange.message';
export default {
    ...
    UserInterchangeUserInterchangeBlog: load(UserInterchangeUserInterchangeBlog, 'user.interchange.blog'),
    UserInterchangeUserInterchangeIbcdex: load(UserInterchangeUserInterchangeIbcdex, 'user.interchange.ibcdex'),
    UserInterchangeUserInterchangeMessage: load(UserInterchangeUserInterchangeMessage, 'user.interchange.message'),
};
